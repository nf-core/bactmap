...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```bash
    nextflow run nf-core/bactmap -profile test,<docker/singularity/conda/institute>
    ```
...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/bactmap -profile <docker/singularity/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```
...
The nf-core/bactmap pipeline comes with documentation about the pipeline which you can read at [https://nf-core/bactmap/docs](https://nf-core/bactmap/docs) or find in the [`docs/` directory](docs).
